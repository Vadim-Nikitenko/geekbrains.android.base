...
import ru.kiradev.weather.custom_views.HumidityView;
import ru.kiradev.weather.custom_views.PressureView;
import ru.kiradev.weather.custom_views.ThermometerView;
import ru.kiradev.weather.custom_views.WindView;
...
import ru.kiradev.weather.recycler_views.RecyclerForecastAdapter;
import ru.kiradev.weather.recycler_views.RecyclerHourlyDataAdapter;
import ru.kiradev.weather.rest.OpenWeatherHelper;
        ...
        OpenWeatherRepo.getInstance().getAPI().loadForecast(cityDetailsData.getCityName(),
                ...
                .enqueue(new Callback<ForecastRequest>() {
                    ...
                    public void onResponse(@NonNull Call<ForecastRequest> call,
                        ...
                        Log.i("loadForecast", "Response " + response.code() + "setupRecyclerView()");
                        if (response.body() != null && response.isSuccessful()) {
                            ...
                            LinearLayoutManager linearLayoutManagerHourly = new LinearLayoutManager(getActivity());
                            linearLayoutManagerHourly.setOrientation(RecyclerView.HORIZONTAL);
                            ...
                            recyclerHourlyView.setLayoutManager(linearLayoutManagerHourly);
